...
// Illyricum/Dalmatia (Western Balkans) - Expanded to connect Italia, Pannonia, and Macedonia
const ILLYRICUM_DETAILED = [
    // Northern border connecting to Italia and Pannonia
    [46.5, 13.5], [46.3, 14.0], [46.1, 14.5], [45.9, 15.0], [45.7, 15.5],
    [45.5, 16.0], [45.3, 16.5], [45.1, 17.0], [44.9, 17.5], [44.7, 18.0],
    [44.5, 18.5], [44.3, 19.0], [44.1, 19.5],
    // Eastern border connecting to Moesia
    [43.9, 19.8], [43.6, 20.0], [43.3, 20.2], [43.0, 20.3],
    // Adriatic coast going south
    [42.7, 20.0], [42.4, 19.5], [42.1, 19.2], [41.8, 19.4], [41.5, 19.6],
    [41.2, 19.8], [40.9, 19.6], [40.6, 19.4], [40.3, 19.5], [40.0, 19.7],
    // Albanian coast connecting to Greece
    [39.7, 20.0], [39.5, 20.3], [39.7, 20.6], [40.0, 20.4],
    // Back north through interior connecting to Macedonia
    [40.3, 20.1], [40.6, 19.8], [40.9, 19.5], [41.2, 19.2], [41.5, 18.9],
    [41.8, 18.6], [42.1, 18.3], [42.4, 18.0], [42.7, 17.6],
    [43.0, 17.2], [43.3, 16.8], [43.6, 16.4], [43.9, 16.0],
    [44.2, 15.5], [44.5, 15.0], [44.8, 14.5], [45.1, 14.0],
    [45.4, 13.6], [45.7, 13.4], [46.0, 13.3], [46.3, 13.4]
];

// Pannonia (Hungary/Austria area) - Expanded to fill gaps and connect all neighbors
const PANNONIA_DETAILED = [
    ...
    [46.5, 19.5], [46.2, 20.0], [45.9, 20.5], [45.6, 21.0],
    // Eastern border connecting to Dacia/Moesia
    [45.3, 21.2], [45.0, 21.0], [44.7, 20.7], [44.4, 20.4], [44.2, 20.0],
    // Southern border connecting to Illyricum/Moesia
    [44.3, 19.5], [44.5, 19.0], [44.7, 18.5], [45.0, 18.0], [45.3, 17.5],
    [45.6, 17.0], [45.9, 16.5], [46.2, 16.0], [46.5, 15.5], [46.8, 15.0],
    // Western border connecting to Noricum
    [47.1, 14.7], [47.4, 14.5], [47.7, 14.4], [48.0, 14.4], [48.3, 14.4],
    [48.6, 14.4]
];

// Dacia (Romania) - Expanded to connect with Pannonia and Moesia
const DACIA_DETAILED = [
    // Northern border (Carpathians)
    [48.0, 22.0], [47.7, 22.5], [47.4, 23.0], [47.1, 23.5], [46.8, 24.0],
    [46.5, 24.5], [46.2, 25.0], [45.9, 25.5], [45.6, 26.0], [45.3, 26.5],
    [45.0, 27.0], [44.7, 27.3],
    // Eastern border (Black Sea approach)
    [44.4, 27.5], [44.1, 27.3], [43.8, 27.0], [43.6, 26.5],
    // Southern border connecting to Moesia
    [43.8, 26.0], [44.0, 25.5], [44.2, 25.0], [44.4, 24.5], [44.6, 24.0],
    [44.8, 23.5], [45.0, 23.0], [45.2, 22.5], [45.4, 22.0], [45.6, 21.5],
    // Western border connecting to Pannonia
    [45.8, 21.0], [46.0, 20.8], [46.3, 21.0], [46.6, 21.3], [46.9, 21.5],
    [47.2, 21.7], [47.5, 21.8], [47.8, 21.9]
];

// Thracia (Thrace) - Expanded to connect Moesia, Macedonia, and Asia Minor
const THRACIA_DETAILED = [
    ...
    // Bosphorus area (Constantinople) connecting to Asia Minor
    [41.0, 29.2], [40.8, 29.0], [40.6, 28.7], [40.4, 28.4], [40.2, 28.1],
    // Sea of Marmara coast
    [40.0, 27.8], [39.8, 27.5], [39.6, 27.2], [39.8, 26.8],
    [40.0, 26.4], [40.2, 26.0], [40.3, 25.5], [40.4, 25.0],
    // Back northwest connecting to Macedonia
    [40.6, 24.6], [40.8, 24.2], [41.0, 23.8], [41.2, 23.4],
    [41.4, 23.0], [41.7, 22.7], [42.0, 22.5], [42.3, 22.4],
    [42.6, 22.3], [42.9, 22.3], [43.2, 22.4], [43.5, 22.4]
];

// Moesia (Bulgaria/Serbia) - Expanded to connect Dacia, Pannonia, Thrace, and Macedonia
const MOESIA_DETAILED = [
    // Northern border along Danube (connecting to Dacia and Pannonia)
    [45.8, 20.5], [45.6, 21.0], [45.4, 21.5], [45.2, 22.0], [45.0, 22.5],
    [44.8, 23.0], [44.6, 23.5], [44.4, 24.0], [44.2, 24.5], [44.0, 25.0],
    [43.8, 25.5], [43.6, 26.0], [43.4, 26.5], [43.2, 27.0], [43.0, 27.5],
    [42.8, 28.0], [42.5, 28.3],
    // Black Sea coast
    [42.2, 28.5], [41.9, 28.3], [41.6, 28.0], [41.4, 27.5],
    // Southern border toward Thrace/Macedonia
    [41.6, 27.0], [41.8, 26.5], [42.0, 26.0], [42.2, 25.5], [42.4, 25.0],
    [42.6, 24.5], [42.8, 24.0], [43.0, 23.5], [43.2, 23.0], [43.4, 22.5],
    [43.6, 22.0], [43.8, 21.5], [44.0, 21.0], [44.2, 20.5], [44.5, 20.2],
    [44.8, 20.0], [45.2, 20.2], [45.5, 20.4]
];
