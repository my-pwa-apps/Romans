...
const ITALIA_DETAILED = [
    ...
    [47.0, 6.5], [47.0, 7.0], [46.8, 7.5], [46.5, 8.0], [46.3, 8.5],
    [46.2, 9.0], [46.0, 9.5], [45.9, 10.0], [46.0, 10.5], [46.2, 11.0],
    [46.5, 11.5], [46.8, 12.0], [47.0, 12.5], [46.8, 13.0], [46.5, 13.5],
    [46.2, 14.0], [45.9, 14.2],
...
const HISPANIA_DETAILED = [
    ...
    [42.0, 3.0], [42.3, 3.2], [42.7, 3.0], [43.0, 2.5], [43.3, 2.0],
    [43.5, 1.5], [43.6, 1.0], [43.7, 0.5], [43.75, 0.0], [43.8, -0.5], [43.8, -1.0]
];
...
const GALLIA_DETAILED = [
    ...
    [45.8, 9.5], [45.6, 9.0], [45.5, 8.5], [45.5, 8.0], [45.4, 7.5],
    [45.3, 7.0], [45.2, 6.8], [45.0, 7.0], [44.5, 7.3], [44.0, 7.5],
    ...
    [43.0, 2.5], [42.8, 2.0], [42.6, 1.5], [42.5, 1.0], [42.6, 0.5],
    [42.8, 0.0], [43.0, -0.5], [43.2, -1.0], [43.4, -1.5],
    // Atlantic coast
...
const ASIA_MINOR_DETAILED = [
    ...
    [40.0, 40.5], [40.0, 41.0], [39.9, 41.5], [39.7, 42.0],
    // Southeast toward Syria - curving down
    [39.4, 42.0], [39.0, 41.5], [38.6, 41.0], [38.2, 40.5], [37.8, 40.0],
    [37.4, 39.5], [37.0, 39.0], [36.6, 38.5], [36.3, 38.0], [36.0, 37.5],
...
const SYRIA_DETAILED = [
    ...
    [37.8, 35.5], [37.5, 36.0], [37.2, 36.5], [36.8, 37.0], [36.5, 37.5],
    [36.2, 38.0], [35.8, 38.5], [35.5, 39.0], [35.2, 39.5], [34.8, 40.0],
    ...
    [31.4, 37.0], [31.2, 36.5], [31.0, 36.0], [30.8, 35.5], [30.8, 35.0],
    [31.0, 34.5], [31.3, 34.0], [31.6, 33.5], [32.0, 33.2],
...
const AEGYPTUS_DETAILED = [
    ...
    [31.5, 23.0], [31.4, 24.0], [31.3, 25.0], [31.2, 26.0], [31.1, 27.0],
    [31.0, 28.0], [31.0, 29.0], [31.1, 30.0], [31.2, 30.5], [31.4, 31.0],
    [31.6, 31.5], [31.8, 32.0],
    // Sinai - Extended to overlap with Judaea/Arabia
    [31.6, 32.5], [31.4, 33.0], [31.2, 33.5], [31.0, 34.0], [30.6, 34.5],
    [30.2, 35.0], [29.8, 35.3], [29.4, 35.5],
...
const AFRICA_DETAILED = [
    ...
    [32.0, 21.0], [31.5, 22.0], [31.2, 22.5], [31.0, 23.0],
    // Southern border - Extended east toward Egypt
    [30.5, 22.5], [30.0, 22.0], [29.5, 21.0], [29.0, 20.0], [28.5, 18.0],
...
const ILLYRICUM_DETAILED = [
    ...
    [47.2, 13.0], [47.0, 13.5], [46.8, 14.0], [46.6, 14.5], [46.4, 15.0],
    ...
    [44.5, 13.4], [44.8, 13.1], [45.1, 12.9], [45.4, 12.8], [45.7, 12.9],
    [46.0, 13.0], [46.3, 13.0], [46.6, 13.0], [46.9, 13.0]
];
...
const PANNONIA_DETAILED = [
    ...
    [44.0, 19.5], [44.3, 19.0], [44.6, 18.5], [44.9, 18.0], [45.2, 17.5],
    [45.5, 17.0], [45.8, 16.5], [46.1, 16.0], [46.4, 15.5], [46.7, 15.0],
...
const DACIA_DETAILED = [
    ...
    [43.2, 26.3], [43.4, 25.8], [43.6, 25.3], [43.8, 24.8], [44.0, 24.3],
    [44.2, 23.8], [44.4, 23.3], [44.6, 22.8], [44.8, 22.3], [45.0, 21.8],
    [45.2, 21.3], [45.4, 20.8], [45.6, 20.3], [45.8, 19.8],
...
const THRACIA_DETAILED = [
    ...
    [41.0, 29.5], [40.8, 29.5], [40.6, 29.2], [40.4, 28.8], [40.2, 28.4],
    // Sea of Marmara coast - Extended south to overlap with Asia Minor
...
const MOESIA_DETAILED = [
    ...
    [46.2, 19.8], [46.0, 20.3], [45.8, 20.8], [45.6, 21.3], [45.4, 21.8],
    [45.2, 22.3], [45.0, 22.8], [44.8, 23.3], [44.6, 23.8], [44.4, 24.3],
    [44.2, 24.8], [44.0, 25.3], [43.8, 25.8], [43.6, 26.3], [43.4, 26.8],
    [43.2, 27.3], [43.0, 27.8], [42.7, 28.2], [42.4, 28.5],
    // Black Sea coast
